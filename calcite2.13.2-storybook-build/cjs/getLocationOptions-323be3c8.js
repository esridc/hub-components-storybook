...
async function getLocationExtent(location, hubRequestOptions) {
    var _a;
    return ((_a = location === null || location === void 0 ? void 0 : location.extent) === null || _a === void 0 ? void 0 : _a.length) ? extent.bBoxToExtent(location.extent)
        : await extent.orgExtent(hubRequestOptions);
}
...
async function getLocationOptions(id, type, location, portalName, hubRequestOptions) {
    const defaultExtent = await extent.orgExtent(hubRequestOptions);
    // Base options
    const optionsArray = [
        {
        ...
        },
        {
            ...
            location: {
                type: "org",
                extent: extent.extentToBBox(defaultExtent),
        ...
        },
        {
            ...
            entityType: getTypeFromEntity.getTypeFromEntity({ type }),
            location: {
                type: "custom",
                spatialReference: defaultExtent.spatialReference,
            },
...
exports.getLocationExtent = getLocationExtent;
