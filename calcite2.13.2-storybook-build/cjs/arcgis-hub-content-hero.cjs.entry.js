...
const ArcgisHubContentHero = class {
  constructor(hostRef) {
    ...
    context.bind(this, 'handleResize');
  }
  /**
  ...
  renderMedia() {
    ...
    return index.h("div", { class: "hero-media" }, media);
  }
  renderThumbnail(thumbnailUrl) {
    // TODO: use the arcgis-hub-image component once styling is resolved
    return (index.h("img", { alt: this.intl.t("thumbnail"), class: "hero-thumbnail", slot: "thumbnail", src: thumbnailUrl }));
  }
  renderMap() {
    return (index.h("arcgis-hub-map", { basemap: this.basemap, expand: 1.5, extent: this.extent, graphics: this.graphics, settings: this.mapSettings }));
  }
  renderHeader() {
    return index.h("div", { class: "hero-header" }, this.heroTitle && index.h("h1", null, this.heroTitle), index.h("slot", { name: SLOTS.header }));
  }
  ;
  renderMain() {
    return index.h("div", { class: "hero-main" }, index.h("slot", { name: SLOTS.main }));
  }
  renderFooter() {
    return (index.h(index.Fragment, null, index.h("div", { class: "hero-footer-start" }, index.h("slot", { name: SLOTS.footerStart })), index.h("div", { class: "hero-footer-end" }, index.h("slot", { name: SLOTS.footerEnd }))));
  }
  render() {
    return (index.h(index.Host, { class: this.hostClass, "data-element": "content-hero" }, this.renderMedia(), index.h("div", { class: "hero-content" }, this.renderHeader(), this.renderMain(), this.renderFooter())));
  }
...
exports.arcgis_hub_content_hero = ArcgisHubContentHero;
