...
const ArcGisPrivacy = class {
  constructor(hostRef) {
    ...
    this.hubUserPrivacySettingsChanged = index.createEvent(this, "hubUserPrivacySettingsChanged", 7);
    ...
    context.bind(this, 'handleAcceptAllClick', 'handleAcceptNecessaryClick', 'handleConfirmClick', 'handleManagePrivacyClick', 'handleModalClose', 'handleNonmodalClose', 'handleSettingsChange', 'handleViewSettingsClick');
  }
  ...
  componentDidLoad() {
    ...
    if (!((_a = this._userSettings) === null || _a === void 0 ? void 0 : _a.accepted)) {
      ...
      this.hubTelemetry.emit(index$1.dist.dictionary.category.interaction.action.viewed.label.notice.details.privacy);
    }
  }
  ...
  async handleManagePrivacyClick() {
    ...
    this.shouldShowNonmodal = false;
    this.hubTelemetry.emit(index$1.dist.dictionary.category.interaction.action.open.label.notice.details.privacy);
  }
  ...
  handleViewSettingsClick() {
    ...
    this.shouldShowNonmodal = false;
    this.shouldShowModal = true;
    this.hubTelemetry.emit(index$1.dist.dictionary.category.interaction.action.open.label.settings.details.privacy);
  }
  ...
  renderButtons() {
    ...
    const reviewSettingsButton = index.h("calcite-button", { appearance: "outline-fill", key: "view-settings", kind: "brand", onClick: this.handleViewSettingsClick, slot: "back", width: "full" }, this.intl.t('notice.reviewSettingsButton'));
    const acceptNecessaryButtonOutline = index.h("calcite-button", { appearance: 'outline', key: "accept-necessary", onClick: this.handleAcceptNecessaryClick, slot: "secondary", width: "full" }, this.intl.t('notice.acceptNecessaryButton'));
    const acceptNecessaryButtonSolid = index.h("calcite-button", { appearance: 'solid', key: "accept-necessary", onClick: this.handleAcceptNecessaryClick, slot: "secondary", width: "full" }, this.intl.t('notice.acceptNecessaryButton'));
    const confirmButton = index.h("calcite-button", { appearance: 'solid', key: "accept-necessary", onClick: this.handleAcceptNecessaryClick, slot: "secondary", width: "full" }, this.intl.t('notice.confirmButton'));
    const acceptAllButton = index.h("calcite-button", { key: "accept-all", onClick: this.handleAcceptAllClick, slot: "primary", width: "full" }, this.intl.t('notice.acceptAllButton'));
   ...
   */
  renderNotice() {
    return index.h(index.Fragment, null, index.h("div", { slot: "header" }, this.intl.t('notice.heading')), index.h("arcgis-privacy-consent", { anonTrackingConfigured: this.anonTrackingConfigured, config: this.config, intl: this.intl, orgInfo: this.orgInfo, slot: "content", thirdPartyTrackingConfigured: this.thirdPartyTrackingConfigured }), this.renderButtons());
  }
  /**
   ...
   */
  renderSettings() {
    return index.h(index.Fragment, null, index.h("div", { slot: "header" }, this.intl.t('settings.heading')), index.h("arcgis-privacy-consent", { anonTrackingConfigured: this.anonTrackingConfigured, config: this.config, intl: this.intl, orgInfo: this.orgInfo, slot: "content", thirdPartyTrackingConfigured: this.thirdPartyTrackingConfigured }), index.h("arcgis-privacy-settings", { anonTrackingConfigured: this.anonTrackingConfigured, intl: this.intl, onHubInternalUserPrivacySettingsChanged: this.handleSettingsChange, orgInfo: this.orgInfo, slot: "content", thirdPartyTrackingConfigured: this.thirdPartyTrackingConfigured, userSettings: this._userSettings }), index.h("calcite-button", { appearance: "solid", onClick: this.handleConfirmClick, slot: "primary", width: "full" }, this.intl.t('settings.confirmButton')));
  }
  /**
  ...
  renderModal() {
    ...
    return index.h("arcgis-wormhole", null, index.h("calcite-modal", { closeButtonDisabled: true, docked: true, escapeDisabled: true, onCalciteModalClose: this.handleModalClose, open: this.shouldShowModal, outsideCloseDisabled: true, scale: "s", width: shouldShowNotice ? "m" : "s" }, this.shouldShowNotice ? this.renderNotice() : this.renderSettings()));
  }
  /**
  ...
  renderNonmodal() {
    ...
    return index.h("arcgis-hub-nonmodal", Object.assign({}, props), this.renderNotice());
  }
  /**
  ...
  renderButton() {
    ...
    if (!this.hideManageButton) {
      result = index.h("calcite-button", { appearance: "transparent", kind: "neutral", onClick: this.handleManagePrivacyClick, scale: "l" }, this.intl.t('managePrivacyButton'));
    }
    return result;
  }
  _render() {
    return index.h(index.Fragment, null, this.renderButton(), this.renderModal(), this.renderNonmodal());
  }
  render() {
    return (index.h(index.Host, { "data-element": "privacy-preferences" }, this._render()));
  }
...
exports.arcgis_privacy = ArcGisPrivacy;
