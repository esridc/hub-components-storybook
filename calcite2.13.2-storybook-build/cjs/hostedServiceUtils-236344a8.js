 ...
 * @returns {boolean}
 */
function hasServiceCapability(capability, serviceDefinition) {
 ...
 */
function toggleServiceCapability(capability, serviceDefinition) {
 ...
 */
function addServiceCapability(capability, serviceDefinition) {
    const capabilities = (serviceDefinition.capabilities || "")
        .split(",")
        .filter((c) => !!c)
        .concat(capability)
        .join(",");
    const updated = Object.assign(Object.assign({}, serviceDefinition), { capabilities });
    return updated;
}
/**
 * @private
 ...
 * @returns a copy of the modified definition
 */
function removeServiceCapability(capability, serviceDefinition) {
    const capabilities = serviceDefinition.capabilities
        .split(",")
...
exports.hasServiceCapability = hasServiceCapability;
...
exports.isSecureProxyServiceUrl = isSecureProxyServiceUrl;
exports.toggleServiceCapability = toggleServiceCapability;
