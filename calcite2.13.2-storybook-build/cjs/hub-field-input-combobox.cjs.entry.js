...
const CalciteComboboxItems = ({ items, values, selectionMode, translationFunc, onCalciteComboboxItemChange, }) => {
  ...
  const label = (child) => {
    return getLabel.getLabel(child, translationFunc) || child.value;
  };
  return items.map((child) => {
    var _a;
    return (index.h("calcite-combobox-item", { heading: label(child), icon: child.icon, key: child.value, label: label(child), onCalciteComboboxItemChange: onCalciteComboboxItemChange, selected: isComboboxItemSelected.isComboboxItemSelected(child, values, selectionMode), 
      ...
      && index.h(CalciteComboboxItems, { items: child.children, onCalciteComboboxItemChange: onCalciteComboboxItemChange, selectionMode: selectionMode, translationFunc: translationFunc, values: values })));
  });
};
...
const Combobox = class {
  constructor(hostRef) {
    ...
    this.handleCalciteComboboxItemChange = (evt) => {
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, index$1.dist.dictionary.category.interaction.action[selected ? "select" : "deselect"]), { label: this.params.telemetryLabel, details: value }));
    };
    this.params = undefined;
    context.bind(this, 'handleCalciteComboboxChange');
  }
  ...
  */
   ...
   */
  renderComboboxItems() {
    return (index.h(CalciteComboboxItems, { items: this._items, onCalciteComboboxItemChange: this.handleCalciteComboboxItemChange, selectionMode: this._selectionMode, translationFunc: this.params.t, values: this.params.value }));
  }
  render() {
    ...
    return (index.h(index.Host, { "data-element": "combobox-field" }, index.h("calcite-combobox", { allowCustomValues: allowCustomValuesBasedOnEnum, clearDisabled: (_c = (_b = this.params.uiSchema) === null || _b === void 0 ? void 0 : _b.options) === null || _c === void 0 ? void 0 : _c.clearDisabled, disabled: this.params.disabled || ((_e = (_d = this.params.uiSchema) === null || _d === void 0 ? void 0 : _d.options) === null || _e === void 0 ? void 0 : _e.disabled), label: getLabel.getLabel(this.params.uiSchema, this.params.t) || this.intl.t('label'), onCalciteComboboxChange: this.handleCalciteComboboxChange, overlayPositioning: (_g = (_f = this.params.uiSchema) === null || _f === void 0 ? void 0 : _f.options) === null || _g === void 0 ? void 0 : _g.overlayPositioning, placeholder: placeholder, placeholderIcon: placeholderIcon, readOnly: (_j = (_h = this.params.uiSchema) === null || _h === void 0 ? void 0 : _h.options) === null || _j === void 0 ? void 0 : _j.readOnly, scale: this.params.scale, selectionMode: this._selectionMode }, this.renderComboboxItems())));
  }
  static get assetsDirs() { return ["locales"]; }
  get element() { return index.getElement(this); }
};

exports.hub_field_input_combobox = Combobox;
