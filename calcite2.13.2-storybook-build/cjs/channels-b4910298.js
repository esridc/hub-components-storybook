...
function fetchChannel(options) {
    ...
    return discussionsApiRequest.discussionsApiRequest(`/channels/${options.channelId}`, options);
}
/**
 * update channel
...
function fetchChannelNotifcationOptOut(options) {
    options.httpMethod = "GET";
    return discussionsApiRequest.discussionsApiRequest(`/channels/${options.channelId}/notifications/opt-out`, options);
}
/**
...
function removeChannelActivity(options) {
    options.httpMethod = "DELETE";
    return discussionsApiRequest.discussionsApiRequest(`/channels/${options.channelId}/activity`, options);
}

exports.createChannel = createChannel;
exports.createChannelNotificationOptOut = createChannelNotificationOptOut;
exports.fetchChannel = fetchChannel;
exports.fetchChannelNotifcationOptOut = fetchChannelNotifcationOptOut;
exports.removeChannelActivity = removeChannelActivity;
exports.removeChannelNotificationOptOut = removeChannelNotificationOptOut;
