...
const ArcgisTelemetryMetric = class {
  ...
  renderFooter() {
    if (!!this.binnedData) {
      ...
      return !this.error && index.h("arcgis-telemetry-chart", Object.assign({ slot: "footer" }, props));
    }
  }
  render() {
    return (index.h(index.Host, null, this.isLoading || this.isTransforming
      ? index.h("arcgis-skeleton-loader", { active: true, rows: 5, showFooter: true })
      : index.h("arcgis-stat-card", { cardTitle: this.reportTitle, corners: interfaces.CORNERS.round, errorMessage: this.error ? { premadeType: interfaces$1.METRIC_ERRORS.generic } : undefined, subtitle: this.subtitle, trailingText: this.trailingText, value: this.value }, this.renderFooter())));
  }
...
exports.arcgis_telemetry_metric = ArcgisTelemetryMetric;
