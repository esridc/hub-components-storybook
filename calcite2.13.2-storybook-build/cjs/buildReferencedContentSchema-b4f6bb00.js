...
function buildReferencedContentSchema(i18nScope, context, label) {
    return {
        ...
        options: {
            ...
            targetEntity: "item",
            catalogs: [
                wellKnownCatalog.getWellKnownCatalog(`${i18nScope}.fields.referencedContent`, "organization", "item", {
...
exports.buildReferencedContentSchema = buildReferencedContentSchema;
