...
function createFolder(requestOptions) {
    return get.determineOwner(requestOptions).then(function (owner) {
        ...
        requestOptions.params = tslib_es6.__assign({ title: requestOptions.title }, requestOptions.params);
...
function createItemInFolder(requestOptions) {
    ...
    return get.determineOwner(requestOptions).then(function (owner) {
        ...
        var options = appendCustomParams.appendCustomParams(requestOptions, [
            ...
            params: tslib_es6.__assign({}, requestOptions.params)
        });
...
function createItem(requestOptions) {
    ...
    var options = tslib_es6.__assign({ folderId: null }, requestOptions);
