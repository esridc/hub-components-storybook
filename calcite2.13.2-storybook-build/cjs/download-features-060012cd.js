...
class CreateReplicaOptionsBuilder {
  ...
  build() {
    return util.cloneObject(this._createReplicaOptions);
  }
}
...
async function _initiateCreateReplica(opts) {
  ...
  const { statusUrl } = await request.request(`${serviceUrl}/createReplica`, requestOptions);
  return statusUrl;
}
...
async function getTotalRecordCount(serviceUrl, options, authentication) {
  ...
  const response = await request.request(`${serviceUrl}/query`, requestOptions);
...
const shouldRecordDownloadErrors = (appContext) => {
  return checkPermission.checkPermission('hub:content:canRecordDownloadErrors', appContext).access;
};
/**
...
async function tryAuthenticatedGet(url, requestOptions) {
  const rawResponse = await request.request(url, Object.assign(Object.assign({}, requestOptions), { rawResponse: true, httpMethod: 'GET' }));
...
exports.CreateReplicaOptionsBuilder = CreateReplicaOptionsBuilder;
exports.FILE_FORMATS = FILE_FORMATS;
exports.fileFormatToDisplayName = fileFormatToDisplayName;
exports.getDownloadUrlFromService = getDownloadUrlFromService;
exports.getTotalRecordCount = getTotalRecordCount;
exports.isAGORateLimitError = isAGORateLimitError;
exports.isILayerOptionsArray = isILayerOptionsArray;
exports.isNumberArray = isNumberArray;
exports.isString = isString;
exports.shouldRecordDownloadErrors = shouldRecordDownloadErrors;
exports.storeCreateReplicaError = storeCreateReplicaError;
