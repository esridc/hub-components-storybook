...
const sha256 = require('./sha256-07a9afb6.js');
...
const addCommonDimensions = (event, options = {}) => {
  ...
  const transformedDimensions = _internal.transformDimensions(event, site);
  const transformedRouteDimensions = _internal.transformDimensions(routeDimensions, site);
  event = Object.assign(Object.assign({}, transformedDimensions), transformedRouteDimensions);
  const response = _internal.getResponse(isSuccess);
  const element = composedPath && _internal.getElementPath(composedPath);
...
exports.addCommonDimensions = addCommonDimensions;
exports.initTelemetry = initTelemetry;
exports.isEueiDisabled = isEueiDisabled;
exports.isHubAnalyticsEnabled = isHubAnalyticsEnabled;
exports.matchesTelemetry = matchesTelemetry;
