...
function getWellknownItemCatalog(i18nScope, catalogName, options) {
    ...
    let catalog;
    const additionalFilters = getProp.getProp(options, "filters") || [];
    const context = getProp.getProp(options, "context");
...
function getAllCollectionsMap(i18nScope, entityType) {
    return {
                ...
                filters: [
                    {
                        predicates: [
                            {
                                type: [...getFamily.getFamilyTypes("app"), ...getFamily.getFamilyTypes("map")],
                            },
                        ],
                    },
                ],
        ...
        dataset: {
            ...
            scope: {
                targetEntity: entityType,
                filters: [{ predicates: [{ type: getFamily.getFamilyTypes("dataset") }] }],
            },
        },
        document: {
            key: "document",
            ...
            scope: {
                targetEntity: entityType,
                filters: [{ predicates: [{ type: getFamily.getFamilyTypes("document") }] }],
            },
        },
        feedback: {
            key: "feedback",
            ...
            scope: {
                targetEntity: entityType,
                filters: [{ predicates: [{ type: getFamily.getFamilyTypes("feedback") }] }],
            },
        },
        site: {
            key: "site",
                ...
                filters: [
                    {
                        predicates: [
                            {
                                type: getFamily.getFamilyTypes("site"),
                            },
                        ],
                    },
                ],
                ...
                filters: [
                    {
                        predicates: [
                            {
                                type: getFamily.getFamilyTypes("template"),
                            },
                        ],
                    },
                ],
                ...
                filters: [
                    {
                        predicates: [
                            {
                                type: getFamily.getFamilyTypes("project"),
                            },
                        ],
                    },
                ],
                ...
                filters: [
                    {
                        predicates: [
                            {
                                type: getFamily.getFamilyTypes("initiative"),
...
exports.dotifyString = dotifyString;
