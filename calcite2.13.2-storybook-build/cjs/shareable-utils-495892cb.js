 ...
 */
function getCardState(element, attributeBlacklist = []) {
 ...
 */
function getLinkAndScriptTags(version) {
 ...
 */
function getSnippetByVal(element, state) {
 ...
 */
function getSnippetByRef(element) {
  const tagName = element.tagName.toLowerCase();
  const innerHTML = element.innerHTML;
...
exports.getLinkAndScriptTags = getLinkAndScriptTags;
exports.getSnippetByRef = getSnippetByRef;
exports.getSnippetByVal = getSnippetByVal;
