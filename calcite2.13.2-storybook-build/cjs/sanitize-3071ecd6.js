...
function SanitizeDecoratorFactory(options) {
  const sanitizer = new index.Sanitizer(options === null || options === void 0 ? void 0 : options.filterOptions, options === null || options === void 0 ? void 0 : options.extendDefaults);
  /**
...
exports.SanitizeDecoratorFactory = SanitizeDecoratorFactory;
