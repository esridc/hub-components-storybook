 ...
 * @returns {string[]}
 */
const getReferencedEntityIds = (entity, associationType) => {
    return getAssociatedEntitiesQuery.getIdsFromKeywords(entity, associationType);
};

exports.getReferencedEntityIds = getReferencedEntityIds;
