...
const Input = class {
  constructor(hostRef) {
    ...
    context.bind(this, 'handleCalciteInputInput', 'setInputElement');
  }
  ...
  _renderCounter() {
    if (this.type === 'text' && this.params.schema.maxLength) {
      return index.h(index.Fragment, null, index.h("calcite-input-message", { id: "character-counter" }, index.h("span", null, this.counterString)), index.h("span", { id: "sr-character-counter", role: "status" }, this.assistiveText));
    }
  }
  ...
  render() {
    return (index.h(index.Host, { "data-test-type": this.type }, this.renderInputField(), this._renderCounter()));
  }
...
__decorate([
  debounce.DebounceDecoratorFactory({ timeout: 2000 })
], Input.prototype, "updateAssistiveText", null);
Input.style = inputCss;

exports.hub_field_input_input = Input;
