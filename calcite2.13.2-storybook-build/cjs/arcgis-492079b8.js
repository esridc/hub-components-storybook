...
const getArcGisCssUrl = () => {
  ...
  return ['light', 'dark'].includes(themeOrUrl)
    ...
    ? `${esriConfig__default['default'].assetsPath}/esri/themes/${themeOrUrl}/main.css`
...
exports.getFirstHitGraphic = getFirstHitGraphic;
exports.injectMapStyleSheet = injectMapStyleSheet;
exports.loadArcGisCss = loadArcGisCss;
exports.setArcGisCssOptions = setArcGisCssOptions;
