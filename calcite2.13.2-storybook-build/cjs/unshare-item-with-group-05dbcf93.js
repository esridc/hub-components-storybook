...
function unshareItemWithGroup(requestOptions) {
    return shareItemWithGroup.isItemSharedWithGroup(requestOptions)
...
function unshareFromGroup(requestOptions) {
    ...
    var url = getPortalUrl.getPortalUrl(requestOptions) + "/content/items/" + requestOptions.id + "/unshare";
    // but if they are the owner, we use a different path...
    if (itemOwner === username) {
        url = getPortalUrl.getPortalUrl(requestOptions) + "/content/users/" + itemOwner + "/items/" + requestOptions.id + "/unshare";
    }
