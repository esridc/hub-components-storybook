...
const store = require('./store-2a385ca0.js');
...
function getPreconfiguredNotices(context) {
  ...
  const NOTICES = {
    ...
    '202404-aboutworkspaces-basic': {
      ...
      telemetry: {
        close: index.dist.dictionary.category.interaction.action.close.label.modal.details.aboutWorkspaces,
        open: index.dist.dictionary.category.interaction.action.open.label.modal.details.aboutWorkspaces
      }
    },
      ...
      actions: [
        {
          ...
          buttonStyle: 'solid',
          telemetry: index.dist.dictionary.category.navigation.action.view.label.users.details.settings
        }
      ],
      telemetry: {
        open: index.dist.dictionary.category.interaction.action.viewed.label.notice.details.introducingWorkspaces,
        close: index.dist.dictionary.category.interaction.action.close.label.modal.details.introducingWorkspaces,
        dismiss: index.dist.dictionary.category.users.action.update.label.optOut.details.phase1Workspaces
      }
    },
      ...
      actions: [
        {
          ...
          telemetry: index.dist.dictionary.category.navigation.action.external.label.arcGisBlog.details.initiativesV2Announcement,
          target: "_blank",
          icon: "launch",
    ...
    '20240517-initiatives-manage': {
      ...
      actions: [
        ...
        },
        {
          ...
          telemetry: Object.assign(Object.assign({}, index.dist.dictionary.category.navigation.action.external.label.arcGisOnline.details.myOrganization), { element: index.dist.constants.element.INITIATIVES_V_2_ANNOUNCEMENT_NOTICE }),
          target: "_blank",
          icon: "launch",
          i18nAriaLabelKey: "ariaLabel",
        }
    ...
    '20240517-initiatives-manage-no-priv': {
      ...
      actions: [
        ...
        },
        {
          ...
          telemetry: Object.assign(Object.assign({}, index.dist.dictionary.category.navigation.action.external.label.arcGisOnline.details.myContent), { element: index.dist.constants.element.INITIATIVES_V_2_ANNOUNCEMENT_NOTICE }),
          target: "_blank",
          icon: "launch",
          i18nAriaLabelKey: "ariaLabel",
        }
    ...
    '20240517-initiatives-introducing-site': {
      ...
      telemetry: {
        open: index.dist.dictionary.category.interaction.action.viewed.label.notice.details.initiativesV2Announcement,
        close: index.dist.dictionary.category.interaction.action.close.label.modal.details.reIntroducingHubInitiatives,
        dismiss: index.dist.dictionary.category.users.action.update.label.optOut.details.initiativesV2Announcement,
      },
      places: [
    ...
    '20240710-slow-service-warning': {
      ...
      telemetry: {
        open: index.dist.dictionary.category.interaction.action.viewed.label.notice.details.slowService
      }
    },
    ...
    '20240710-unreachable-service-error': {
      ...
      telemetry: {
        open: index.dist.dictionary.category.interaction.action.viewed.label.notice.details.downService,
      }
    },
    ...
    '20240807-auth-required-status': {
      ...
      telemetry: {
        open: index.dist.dictionary.category.interaction.action.viewed.label.notice.details.authRequired,
      }
    },
 ...
 */
const getGlobalContext = () => store.store.state.context;
/**
...
function showNotice(noticeOrId) {
  ...
  if (typeof noticeOrId === 'string') {
    ...
    notice = noticeOrId;
    if (!notice.id) {
      notice.id = util.createId('notice');
    }
  }
  store.store.state.notices = [...store.store.state.notices, notice];
  return notice;
}
const removeNotice = (noticeId) => {
  store.store.state.notices = store.store.state.notices.filter(a => a.id !== noticeId);
};
/**
...
function setUrlState(urlState) {
  const newState = Object.assign({}, store.store.state.urlState);
  // update the state with the new values
  Object.keys(urlState).forEach(key => {
    newState[key] = Object.assign(Object.assign({}, newState[key]), urlState[key]);
  });
  // update the store
  store.store.state.urlState = newState;
  const flattenedUrlState = {};
  // flatten the url state
  Object.keys(newState).forEach(key => {
    Object.keys(newState[key]).forEach(paramKey => {
      flattenedUrlState[`${key}${URL_STATE_SEPARATOR}${paramKey}`] = store.store.state.urlState[key][paramKey];
    });
  });
...
function getUrlState(componentKey) {
  return store.store.state.urlState[componentKey] || {};
}
/**
...
function initializeUrlState(urlSearchParams) {
  ...
  store.store.state.urlState = urlState;
}
/**
...
const connectContext = (component) => {
  component.disconnectContext = store.store.onChange('context', function (context) {
    component._context = context;
  });
};

exports.URL_STATE_SEPARATOR = URL_STATE_SEPARATOR;
exports.connectContext = connectContext;
exports.getCurrentSite = getCurrentSite;
exports.getGlobalContext = getGlobalContext;
exports.getNotices = getNotices;
exports.getPreconfiguredNotice = getPreconfiguredNotice;
exports.getPreconfiguredNotices = getPreconfiguredNotices;
exports.getUrlState = getUrlState;
exports.initializeUrlState = initializeUrlState;
exports.removeNotice = removeNotice;
exports.setCurrentSite = setCurrentSite;
exports.setGlobalContext = setGlobalContext;
exports.setUrlState = setUrlState;
exports.showNotice = showNotice;
exports.validUrlStateParams = validUrlStateParams;
