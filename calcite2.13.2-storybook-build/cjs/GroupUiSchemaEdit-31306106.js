        ...
        elements: [
            {
                ...
                elements: [
                    ...
                    ...getThumbnailUiSchemaElement.getThumbnailUiSchemaElement(i18nScope, options.thumbnail, getEntityThumbnailUrl.getEntityThumbnailUrl(options), "group", context.requestOptions),
                ],
            },
        ],
    };
