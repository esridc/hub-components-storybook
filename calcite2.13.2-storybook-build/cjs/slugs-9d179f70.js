...
const parseIdentifier = (identifier) => {
    ...
    let id = isGuid.isGuid(identifier) && identifier;
    if (!id) {
...
exports.TYPEKEYWORD_SLUG_PREFIX = TYPEKEYWORD_SLUG_PREFIX;
exports.appendIdToSlug = appendIdToSlug;
exports.getSlugMaxLength = getSlugMaxLength;
exports.keywordSlugToUriSlug = keywordSlugToUriSlug;
exports.parseIdentifier = parseIdentifier;
exports.truncateSlug = truncateSlug;
exports.uriSlugToKeywordSlug = uriSlugToKeywordSlug;
