export const SUBTITLE = `The following harness demonstrates how to include block sectioning in your editor:
  ...
  elements: [
    ...
    },
    {
      ...
      options: {
        section: "block",
        helperText: {
          label: 'The "Additional Settings" section is a block section, and is collapsible.',
          placement: "top"
        }
      },
      elements: [
        {
          ...
          options: {
            ...
            helperText: {
              label: 'The "Appearance Settings" section is a subblock subsection.'
            }
          },
          elements: [
            {
        ...
        },
        {
          ...
          options: {
            ...
            scale: "m",
            helperText: {
              label: 'The "Server Settings" section is a subblock subsection.'
            }
          },
          elements: [
            {
