...
import { g as getUiSchema, a as getSchema, D as DEFAULT_FIELD_TO_RELATIONSHIP, E as ExpressionRelationships } from './resources-3b88c839.js';
import { g as getIconForFieldType } from './feature-service-308c7df6.js';
...
const ExpressionSet = class {
  constructor(hostRef) {
    ...
    this.arcgisCompositeExpressionSetFieldChange = createEvent(this, "arcgisCompositeExpressionSetFieldChange", 7);
    this.values = {};
    this.fields = [];
    this.expressions = [];
...
export { ExpressionSet as hub_composite_input_expression_set };
