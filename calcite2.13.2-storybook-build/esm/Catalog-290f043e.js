...
import { d as fetchSite, u as upgradeCatalogSchema } from './HubInitiatives-4f4e24ce.js';
        ...
        if (queryResponse.results.length) {
            if (pred.id) {
                ...
                isContained = queryResponse.results.reduce((slugKeywordPresent, entry) => {
                    ...
                    getWithDefault(entry, "typeKeywords", getWithDefault(entry, "rawResult.typeKeywords", []));
...
async function fetchEntityCatalog(identifier, context, options) {
    ...
    if (identifier.indexOf("http") === 0) {
        ...
        catalog = getProp(site, (options === null || options === void 0 ? void 0 : options.prop) || "catalog");
    }
        ...
        catalog = getProp(entity, (options === null || options === void 0 ? void 0 : options.prop) || "catalog");
    }
        ...
        catalog = getProp(event, (options === null || options === void 0 ? void 0 : options.prop) || "catalog");
    }
    else {
        throw new HubError("Catalog.init", "Identifier must be a url, item or event id");
    }
    return catalog;
}
...
class Catalog {
    ...
    getCollectionJson(name) {
        ...
        if (json) {
            ...
            throw new HubError("getCollectionJson", `Collection "${name}" is not present in the Catalog`);
        }
    }
    /**
...
export { Catalog as C, Collection as a, catalogContains as c, getHubTypeFromItemType as g, isCuid as i };
