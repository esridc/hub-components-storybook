...
import { i as SiteDefaultFeatures, l as SiteVersionIncludeList, m as PageVersionIncludeList } from './TemplateBusinessRules-0e35d61b.js';
import { d as fetchSite, P as ENTERPRISE_SITE_ITEM_TYPE, Q as HUB_SITE_ITEM_TYPE, D as updateSite, R as createSite, S as deleteSite, T as getPropertyMap, I as editorToEntity } from './HubInitiatives-4f4e24ce.js';
import { d as deepContains } from './deepContains-ff859c50.js';
import { c as createId, a as cloneObject } from './util-3e6872d9.js';
import { P as PropertyMapper } from './PropertyMapper-4eb0ac8f.js';
import { V as VERSION_RESOURCE_NAME, a as VERSION_RESOURCE_PROPERTIES, g as getPrefix, b as getVersion, s as searchVersions, u as updateVersionMetadata, d as deleteVersion } from './updateVersionMetadata-068ede7c.js';
import { i as isSiteType, e as isPageType } from './compose-d5b83ab7.js';
...
import { p as addItemResource } from './themes-e08327b4.js';
import { u as updateItemResource } from './update-6a7d5697.js';
import { s as setProp } from './set-prop-9a4aa9a9.js';
import { i as isDiscussable } from './utils-6bf1b713.js';
...
async function createVersion(model, requestOptions, options) {
    ...
    await addItemResource(Object.assign(Object.assign({}, requestOptions), { id: getProp(model, "item.id"), name: VERSION_RESOURCE_NAME, owner: getProp(model, "item.owner"), params: { properties }, prefix, resource: versionBlob }));
...
async function updateVersion(model, version, requestOptions, force) {
    ...
    const versionBlob = objectToJsonBlob(version);
    const properties = mergeObjects(version, {}, VERSION_RESOURCE_PROPERTIES);
    await updateItemResource(Object.assign(Object.assign({}, requestOptions), { id: getProp(model, "item.id"), name: VERSION_RESOURCE_NAME, owner: getProp(model, "item.owner"), params: { properties }, prefix, resource: versionBlob }));
    return version;
}
 ...
 */
class HubSite extends HubItemEntity {
    /**
    ...
    async contains(identifier, hierarchy = []) {
        ...
        // delegate to fn
        const response = await deepContains(identifier, "content", // NOTE: this is hardcoded for now!
    ...
    */
    ...
    async updateVersionMetadata(version) {
        return updateVersionMetadata(this.entity.id, version, this.entity.owner, this.context.userRequestOptions);
    }
    /**
    ...
    async toEditor(editorContext = {}, include = []) {
        ...
        setProp("_followers.showFollowAction", this.entity.features["hub:site:feature:follow"], editor);
...
export { HubSite as H, applyVersion as a, checkForStaleVersion as b, createVersion as c, updateVersion as u };
