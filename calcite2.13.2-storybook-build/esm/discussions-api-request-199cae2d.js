import { R as RemoteServerError$1, b as buildUrl } from './request-3e386aeb.js';
import { S as SearchPostsFormat } from './utils-6bf1b713.js';
...
function apiRequest(route, options, token) {
    ...
    const isCSV = ["/posts", "/posts/search"].includes(route) &&
        (((_a = options.data) === null || _a === void 0 ? void 0 : _a.f) === SearchPostsFormat.CSV ||
...
export { discussionsApiRequest as d };
