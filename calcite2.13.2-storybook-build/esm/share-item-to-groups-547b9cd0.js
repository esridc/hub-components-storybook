...
async function shareItemToGroups(itemId, groupIds, requestOptions, owner) {
    const fn = searchGroups.bind(undefined, Object.assign({ q: `id:(${groupIds.join(" OR ")})`, num: groupIds.length }, requestOptions));
