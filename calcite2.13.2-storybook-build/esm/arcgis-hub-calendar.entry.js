import { r as registerInstance, c as createEvent, h as h$1, H as Host, a as getElement } from './index-57f71b44.js';
...
const ArcgisHubCalendar = class {
  constructor(hostRef) {
    ...
    this.hubCalendarDateSelected = createEvent(this, "hubCalendarDateSelected", 7);
    this.hubCalendarDateUnselected = createEvent(this, "hubCalendarDateUnselected", 7);
    /**
  ...
  renderEventPopover() {
    if (this.selectedEvent) {
      return (h$1("calcite-popover", { autoClose: true, onCalcitePopoverClose: this.handleCalcitePopoverClosed, open: true, referenceElement: this.selectedEvent.el }, h$1("arcgis-hub-entity-card", { searchResult: this.selectedEvent.event.extendedProps })));
    }
  }
  /**
   ...
   */
  renderCalendar() {
    return (h$1("full-calendar", { ref: (el) => {
   ...
   */
  render() {
    return (h$1(Host, { "data-element": "hub-calendar" }, this.renderCalendar(), this.renderEventPopover()));
  }
...
export { ArcgisHubCalendar as arcgis_hub_calendar };
