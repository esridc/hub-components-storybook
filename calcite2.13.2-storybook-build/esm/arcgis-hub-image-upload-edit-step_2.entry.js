...
const ArcgisHubImageUploadEditStep = class {
  constructor(hostRef) {
    ...
    this.arcgisImageUploadEditStepImageChanged = createEvent(this, "arcgisImageUploadEditStepImageChanged", 7);
...
const ArcgisHubImageUploadFileStep = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.arcgisImageUploadFileStepFileChange = createEvent(this, "arcgisImageUploadFileStepFileChange", 7);
    this.arcgisImageUploadFileStepInvalidFile = createEvent(this, "arcgisImageUploadFileStepInvalidFile", 7);
...
export { ArcgisHubImageUploadEditStep as arcgis_hub_image_upload_edit_step, ArcgisHubImageUploadFileStep as arcgis_hub_image_upload_file_step };
