import { g as getPortalApiUrl, a as getEnvironmentFromPortalUrl } from './get-portal-api-url-8aa1582b.js';
import { c as collections, g as getFamily } from './get-family-543fac52.js';
...
import { d as camelize, i as isNil } from './util-3e6872d9.js';
import { e as extentToPolygon, i as isBBox, c as extentToBBox, g as getExtentCenter, b as bBoxToExtent, G as GeoJSONPolygonToBBox, d as allCoordinatesPossiblyWGS84 } from './extent-34a4ba2a.js';
...
const deriveLocationFromItem = (item) => {
    ...
    // from item extent
    const geometry = getExtentObject(extent);
    if (geometry) {
        ...
        try {
            ...
            const bbox = GeoJSONPolygonToBBox(extent);
            const defaultSpatialReference = { wkid: 4326 };
            const _geometry = Object.assign(Object.assign({ type: "polygon" }, geojsonToArcGIS(extent)), { spatialReference: allCoordinatesPossiblyWGS84(bbox)
...
export { getItemLayerId as A, getItemHubId as B, parseItemCategories as C, isLayerView as D, getItemApiUrl as E, getItemDataUrl as F, PublisherSource as P, UpdateFrequency as U, _getHubUrlFromPortalHostname as _, includes as a, getItemThumbnailUrl as b, getHubRelativeUrl as c, deriveLocationFromItem as d, isPageType as e, getItemOrgId as f, getHubApiUrl as g, getContentEditUrl as h, isSiteType as i, getAdditionalResources as j, getSchedulerApiUrl as k, composeContent as l, canUseHubApiForItem as m, normalizeItemType as n, getItemLayer as o, getProxyUrl as p, geojsonToArcGIS as q, arcgisToGeoJSON as r, getLayerIdFromUrl as s, forceUpdateContent as t, getContentTypeIcon as u, getShortenedCategories as v, categories as w, isDownloadable as x, getPortalUrls as y, isFeatureService as z };
