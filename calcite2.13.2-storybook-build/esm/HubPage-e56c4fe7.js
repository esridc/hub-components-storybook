import { a as fetchPage, V as DEFAULT_PAGE, W as ENTERPRISE_PAGE_ITEM_TYPE, X as HUB_PAGE_ITEM_TYPE, B as updatePage, Y as createPage, Z as deletePage, I as editorToEntity } from './HubInitiatives-4f4e24ce.js';
 ...
 */
class HubPage extends HubItemEntity {
    /**
    ...
    static applyDefaults(partialPage, context) {
        ...
        const pojo = Object.assign(Object.assign({}, DEFAULT_PAGE), partialPage);
    ...
    async save() {
        ...
        if (this.entity.id) {
            // update it
            this.entity = await updatePage(this.entity, this.context.userRequestOptions);
        }
        else {
            // create it
            this.entity = await createPage(this.entity, this.context.userRequestOptions);
        }
