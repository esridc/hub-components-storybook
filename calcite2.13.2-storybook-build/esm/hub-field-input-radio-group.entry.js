...
const RadioGroup = class {
  ...
  handleCalciteSegmentedControlChange(evt) {
    ...
    this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.interaction.action.select), { label: this.params.telemetryLabel, details: evt.target.value }));
  }
...
export { RadioGroup as hub_field_input_radio_group };
