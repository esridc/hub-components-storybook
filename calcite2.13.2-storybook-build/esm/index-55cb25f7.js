...
function getDefaultWhiteList$1$1 () {
  // 白名单值说明：
  // true: 允许该属性
 ...
 * @return {String}
 */
function onAttr$1 (name, value, options) {
  // do nothing
}
...
var REGEXP_URL_JAVASCRIPT$1 = /javascript\s*\:/img;
 ...
 * @return {String}
 */
function safeAttrValue$1$1(name, value) {
  if (REGEXP_URL_JAVASCRIPT$1.test(value)) return '';
  return value;
}


_default$2.whiteList = getDefaultWhiteList$1$1();
_default$2.getDefaultWhiteList = getDefaultWhiteList$1$1;
_default$2.onAttr = onAttr$1;
_default$2.onIgnoreAttr = onIgnoreAttr$1;
_default$2.safeAttrValue = safeAttrValue$1$1;
...
var DEFAULT$1 = _default$2;
var parseStyle$2 = parser$2;
 ...
 * @return {Object}
 */
function shallowCopyObject$1$1 (obj) {
  var ret = {};
  for (var i in obj) {
    ret[i] = obj[i];
  }
 ...
 */
function FilterCSS$2$1 (options) {
  options = shallowCopyObject$1$1(options || {});
...
FilterCSS$2$1.prototype.process = function (css) {
  // 兼容各种奇葩输入
  css = css || '';
  css = css.toString();
  if (!css) return '';
  ...
  var retCSS = parseStyle$2(css, function (sourcePosition, position, name, value, source) {
...
var FilterCSS$1$1 = lib$2.exports.FilterCSS;
var getDefaultCSSWhiteList$1 = lib$2.exports.getDefaultWhiteList;
var _$2 = util$2;

function getDefaultWhiteList$2() {
  return {
    a: ["target", "href", "title"],
    abbr: ["title"],
    address: [],
...
var defaultCSSFilter$1 = new FilterCSS$1$1();
 ...
 * @return {String}
 */
function onTag$1(tag, html, options) {
  // do nothing
}
 ...
 * @return {String}
 */
function onIgnoreTag$1(tag, html, options) {
  // do nothing
}
 ...
 * @return {String}
 */
function onTagAttr$1(tag, name, value) {
  // do nothing
}
 ...
 * @return {String}
 */
function onIgnoreTagAttr$1(tag, name, value) {
  // do nothing
}
...
function escapeHtml$1(html) {
  return html.replace(REGEXP_LT$1, "&lt;").replace(REGEXP_GT$1, "&gt;");
}
 ...
 * @return {String}
 */
function safeAttrValue$2(tag, name, value, cssFilter) {
  // unescape attribute value firstly
  value = friendlyAttrValue$1(value);
  ...
  if (name === "href" || name === "src") {
    ...
    if (cssFilter !== false) {
      cssFilter = cssFilter || defaultCSSFilter$1;
      value = cssFilter.process(value);
    }
  }

  // escape `<>"` before returns
  value = escapeAttrValue$1(value);
  return value;
}
...
var REGEXP_LT$1 = /</g;
var REGEXP_GT$1 = />/g;
var REGEXP_QUOTE$1 = /"/g;
var REGEXP_QUOTE_2$1 = /&quot;/g;
var REGEXP_ATTR_VALUE_1$1 = /&#([a-zA-Z0-9]*);?/gim;
var REGEXP_ATTR_VALUE_COLON$1 = /&colon;?/gim;
var REGEXP_ATTR_VALUE_NEWLINE$1 = /&newline;?/gim;
 ...
 * @return {String} str
 */
function escapeQuote$1(str) {
  return str.replace(REGEXP_QUOTE$1, "&quot;");
}
 ...
 * @return {String} str
 */
function unescapeQuote$1(str) {
  return str.replace(REGEXP_QUOTE_2$1, '"');
}
 ...
 * @return {String}
 */
function escapeHtmlEntities$1(str) {
  return str.replace(REGEXP_ATTR_VALUE_1$1, function replaceUnicode(str, code) {
 ...
 * @return {String}
 */
function escapeDangerHtml5Entities$1(str) {
  return str
    .replace(REGEXP_ATTR_VALUE_COLON$1, ":")
    .replace(REGEXP_ATTR_VALUE_NEWLINE$1, " ");
}
 ...
 * @return {String}
 */
function clearNonPrintableCharacter$1(str) {
  var str2 = "";
 ...
 * @return {String}
 */
function friendlyAttrValue$1(str) {
  str = unescapeQuote$1(str);
  str = escapeHtmlEntities$1(str);
  str = escapeDangerHtml5Entities$1(str);
  str = clearNonPrintableCharacter$1(str);
  return str;
}
 ...
 * @return {String}
 */
function escapeAttrValue$1(str) {
  str = escapeQuote$1(str);
 ...
 */
function onIgnoreTagStripAll$1() {
  return "";
}
 ...
 * @param {function} next
 */
function StripTagBody$1(tags, next) {
 ...
 * @return {String}
 */
function stripCommentTag$1(html) {
  var retHtml = "";
  var lastPos = 0;
 ...
 * @return {String}
 */
function stripBlankChar$1(html) {
...
_default$1$1.whiteList = getDefaultWhiteList$2();
_default$1$1.getDefaultWhiteList = getDefaultWhiteList$2;
_default$1$1.onTag = onTag$1;
_default$1$1.onIgnoreTag = onIgnoreTag$1;
_default$1$1.onTagAttr = onTagAttr$1;
_default$1$1.onIgnoreTagAttr = onIgnoreTagAttr$1;
_default$1$1.safeAttrValue = safeAttrValue$2;
_default$1$1.escapeHtml = escapeHtml$1;
_default$1$1.escapeQuote = escapeQuote$1;
_default$1$1.unescapeQuote = unescapeQuote$1;
_default$1$1.escapeHtmlEntities = escapeHtmlEntities$1;
_default$1$1.escapeDangerHtml5Entities = escapeDangerHtml5Entities$1;
_default$1$1.clearNonPrintableCharacter = clearNonPrintableCharacter$1;
_default$1$1.friendlyAttrValue = friendlyAttrValue$1;
_default$1$1.escapeAttrValue = escapeAttrValue$1;
_default$1$1.onIgnoreTagStripAll = onIgnoreTagStripAll$1;
_default$1$1.StripTagBody = StripTagBody$1;
_default$1$1.stripCommentTag = stripCommentTag$1;
_default$1$1.stripBlankChar = stripBlankChar$1;
_default$1$1.cssFilter = defaultCSSFilter$1;
_default$1$1.getDefaultCSSWhiteList = getDefaultCSSWhiteList$1;
 ...
 * @return {String}
 */
function parseTag$1$1(html, onTag, escapeHtml) {
    ...
    if (tagStart === false) {
      ...
      if (quoteStart === false) {
        ...
        if (c === ">") {
          ...
          currentTagName = getTagName$1(currentHtml);
          rethtml += onTag(
            tagStart,
            rethtml.length,
            currentTagName,
            currentHtml,
            isClosing$1(currentHtml)
          );
...
var REGEXP_ILLEGAL_ATTR_NAME$1 = /[^a-zA-Z0-9\\_:.-]/gim;
 ...
 * @return {String}
 */
function parseAttr$1$1(html, onAttr) {
  ...
  function addAttr(name, value) {
    name = _$1.trim(name);
    name = name.replace(REGEXP_ILLEGAL_ATTR_NAME$1, "").toLowerCase();
  ...
  for (var i = 0; i < len; i++) {
    ...
    if (tmpName === false && c === "=") {
      ...
      lastPos = i + 1;
      lastMarkPos = html.charAt(lastPos) === '"' || html.charAt(lastPos) === "'" ? lastPos : findNextQuotationMark$1(html, i + 1);
      continue;
    }
    if (tmpName !== false) {
      if (
    ...
    if (/\s|\n|\t/.test(c)) {
      ...
      if (tmpName === false) {
        ...
        j = findBeforeEqual$1(html, i - 1);
        if (j === -1) {
          v = _$1.trim(html.slice(lastPos, i));
          v = stripQuoteWrap$1(v);
          addAttr(tmpName, v);
          tmpName = false;
          lastPos = i + 1;
          continue;
  ...
  if (lastPos < html.length) {
    if (tmpName === false) {
      ...
      addAttr(tmpName, stripQuoteWrap$1(_$1.trim(html.slice(lastPos))));
    }
  }
...
function findNextEqual$1(str, i) {
  for (; i < str.length; i++) {
    var c = str[i];
    if (c === " ") continue;
    if (c === "=") return i;
...
function findNextQuotationMark$1(str, i) {
  for (; i < str.length; i++) {
    var c = str[i];
    if (c === " ") continue;
    if (c === "'" || c === '"') return i;
...
function findBeforeEqual$1(str, i) {
  for (; i > 0; i--) {
    var c = str[i];
    if (c === " ") continue;
    if (c === "=") return i;
...
function isQuoteWrapString$1(text) {
  if (
...
function stripQuoteWrap$1(text) {
  if (isQuoteWrapString$1(text)) {
...
parser$1$1.parseTag = parseTag$1$1;
parser$1$1.parseAttr = parseAttr$1$1;
...
var FilterCSS$3 = lib$2.exports.FilterCSS;
var DEFAULT = _default$1$1;
var parser$3 = parser$1$1;
var parseTag$2 = parser$3.parseTag;
var parseAttr$2 = parser$3.parseAttr;
var _ = util$2;
 ...
 * @return {Object}
 */
function shallowCopyObject$2(obj) {
  var ret = {};
  for (var i in obj) {
    ret[i] = obj[i];
  }
...
function keysToLowerCase$1(obj) {
  var ret = {};
  for (var i in obj) {
...
function FilterXSS$1(options) {
  options = shallowCopyObject$2(options || {});
  ...
  if (options.whiteList || options.allowList) {
    options.whiteList = keysToLowerCase$1(options.whiteList || options.allowList);
  } else {
  ...
  if (options.css === false) {
    ...
    this.cssFilter = new FilterCSS$3(options.css);
  }
}
  ...
  var retHtml = parseTag$2(
    ...
    function (sourcePosition, position, tag, html, isClosing) {
      ...
      if (info.isWhite) {
        ...
        var attrs = getAttrs$1(html);
        var whiteAttrList = whiteList[tag];
        var attrsHtml = parseAttr$2(attrs.html, function (name, value) {
          // call `onTagAttr()`
...
var Sanitizer = /** @class */ (function () {
    function Sanitizer(filterOptions, extendDefaults) {
        ...
        this.arcgisFilterOptions = {
            ...
            safeAttrValue: function (tag, name, value, cssFilter) {
                ...
                return lib$1$1.exports.safeAttrValue(tag, name, value, cssFilter);
            },
        };
        this._entityMap = {
            "&": "&#x38;",
        ...
        this._xssFilter = new lib$1$1.exports.FilterXSS(xssFilterOptions);
    }
    /**
    ...
    Sanitizer.prototype.sanitizeUrl = function (value, options) {
        ...
        if (isRootUrl || isUrlFragment || isValidProtocol) {
            return lib$1$1.exports.escapeAttrValue(value);
        }
        if (!protocol && !isProtocolRequired) {
            return lib$1$1.exports.escapeAttrValue("https://".concat(value));
        }
        return "";
    };
    /**
    ...
    Sanitizer.prototype.sanitizeHTMLAttribute = function (tag, attribute, value, cssFilter) {
        ...
        return lib$1$1.exports.safeAttrValue(tag, attribute, value, cssFilter);
    };
    /**
...
export { Sanitizer as S, lib as l };
