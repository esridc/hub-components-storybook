import { a as fetchHubGroup, D as DEFAULT_GROUP, u as updateHubGroup, c as createHubGroup, d as deleteHubGroup } from './hubSearch-41612481.js';
import { m as convertHubGroupToGroup, k as getGroupThumbnailUrl } from './HubInitiatives-4f4e24ce.js';
...
import { a as addPermissionPolicy, r as removePermissionPolicy, e as enrichEntity } from './enrichEntity-a5bc0b4f.js';
...
async function setGroupThumbnail(id, file, filename, requestOptions, owner) {
    ...
    try {
        ...
        if (!response.success) {
            throw new HubError("Set Group Thumbnail", "Unknown error setting thumbnail.");
        }
    }
    catch (err) {
...
class HubGroup {
    ...
    static applyDefaults(partialGroup) {
        ...
        return Object.assign(Object.assign({}, DEFAULT_GROUP), partialGroup);
    }
    /**
    ...
    async save() {
        ...
        if (this.entity.id) {
            // update it
            this.entity = await updateHubGroup(this.entity, this.context.userRequestOptions);
        }
        else {
            // create it
            this.entity = await createHubGroup(this.entity, this.context.userRequestOptions);
        }
        return;
    }
    /**
    ...
    async fromEditor(editor) {
        ...
        if (this.thumbnailCache) {
            if (this.thumbnailCache.clear) {
                ...
                this.entity.thumbnailUrl = getGroupThumbnailUrl(this.context.userRequestOptions.portal, group);
