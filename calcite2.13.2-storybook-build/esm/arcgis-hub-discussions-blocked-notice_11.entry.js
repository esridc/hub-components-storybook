import { r as registerInstance, c as createEvent, h, H as Host, a as getElement, d as getAssetPath, F as Fragment } from './index-57f71b44.js';
import { i as intlManager } from './intl-manager-13176c32.js';
import { b as bind } from './context-7d8f7366.js';
import { d as dist } from './index-dd3f99ac.js';
import { d as ArcgisHubDiscussionsBlockedNoticeConfigs, e as fetchMemberFromCache, f as fetchPostDetails, a as fetchPostUserDetails, b as fetchParentDetails, c as fetchParentUserDetails, A as ArcgisHubDiscussionsBlockedNoticeVariant } from './fetch-parent-user-details-ef8f8532.js';
import { g as getChannelName, r as removePost, j as updatePostStatus, i as fetchPost, s as searchPosts, k as augmentDiscussionURIWithFeature, l as featuresToGeometryCollection, m as createPost, n as determineChannelOwner, c as postToFeatures, o as updatePost, p as parseDiscussionURI, M as MAX_TITLE_LENGTH, q as MAX_BODY_LENGTH, W as WARNING_BODY_LENGTH, t as createReply, v as pluckDiscussionFeatureIds, w as fetchRelatedFeatures, e as convertGeometryTypeToTelemetryString } from './discussions-a173baa3.js';
...
import { a as SharingAccess, C as CANNOT_DISCUSS, h as PostStatus, f as PostRelation, j as ChannelFilter, k as ChannelSort, d as SortOrder, P as PostSort, i as isDiscussable, l as getChannelUsersQuery, m as PostReaction } from './utils-6bf1b713.js';
import { a as autoLink, h as highlightWords } from './string-21a7833f.js';
...
import { a as isOrgAdminInOrg, b as isUserInOrg, u as userHasPrivileges, C as ChannelPermission, i as isOrgAdmin } from './channel-permission-1e298c3b.js';
...
import { f as fetchChannel, u as updateChannel } from './channels-3a706fa2.js';
...
const ArcgisHubDiscussionsPopover = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.hubTelemetry = createEvent(this, "hubTelemetry", 7);
    this.arcgisHubDiscussionPopoverBeforeOpen = createEvent(this, "arcgisHubDiscussionPopoverBeforeOpen", 7);
    this.arcgisHubDiscussionPopoverClose = createEvent(this, "arcgisHubDiscussionPopoverClose", 7);
...
const ArcgisHubDiscussionsPost = class {
  ...
  constructor(hostRef) {
    ...
    this.hubTelemetry = createEvent(this, "hubTelemetry", 7);
    this.arcgisHubDiscussionsPostReady = createEvent(this, "arcgisHubDiscussionsPostReady", 7);
  ...
  handleCalcitePopoverOpen(evt) {
    ...
    if (evt.target !== this.menuPopoverElement && ((_a = this.menuPopoverElement) === null || _a === void 0 ? void 0 : _a.open)) {
      ...
      this.emitHubTelemetry(Object.assign(Object.assign({}, dist.dictionary.category.interaction.action.open.label.popover.details.options), { position: this.index }));
    }
  }
  /**
  ...
  handleEdit() {
    ...
    this.emitHubTelemetry(Object.assign(Object.assign({}, dist.dictionary.category.interaction.action.open.label.editor), { position: this.index }));
  }
  /**
  ...
  handleToggleVisibility() {
    ...
    return updatePostStatus(Object.assign({ data: {
      ...
      this.emitHubTelemetry(Object.assign(Object.assign({}, dist.dictionary.category.content.action.update.label.status.details[details]), { response: dist.constants.response.SUCCESS }));
      this.arcgisHubDiscussionsPostEdit.emit(editedPost);
      return editedPost;
    })
      .catch(e => {
      console.error('Could not update post status:', e.message);
      this.emitHubTelemetry(Object.assign(Object.assign({}, dist.dictionary.category.content.action.update.label.status.details[details]), { response: dist.constants.response.FAILURE }));
      return null;
    });
  }
  /**
  ...
  handleLinkClicked(evt) {
    ...
    if (['CALCITE-LINK'].includes(el.nodeName) && !el.hasAttribute('data-mention')) {
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.navigation.action.external.label.link), { details: el.href, postId: postId, parentId, channelId: channel.id, channelAccess: channel.access, position: index }));
    }
  }
  /**
...
__decorate$4([
  MemoizeDecoratorFactory('post.body', 'post.status'),
...
__decorate$4([
  MemoizeDecoratorFactory('post.title', 'post.status'),
  ...
  get chipsToRender() {
    ...
    if (post.status === PostStatus.HIDDEN || post.status === PostStatus.BLOCKED) {
      chips.push({
        ...
        kind: 'neutral',
        tooltip: {
          telemetry: dist.dictionary.category.interaction.action.open.label.tooltip.details.chipComponentWithStringHidden,
...
async function searchChannelsWithRecentUserActivity(userId, hubRequestOptions) {
  const _a = await searchChannels(Object.assign({ data: {
    ...
    } }, hubRequestOptions)), { items: channels } = _a, results = __rest$1(_a, ["items"]);
...
const ArcgisHubDiscussionsPostEditor = class {
  ...
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.arcgisHubDiscussionsPostEditorReady = createEvent(this, "arcgisHubDiscussionsPostEditorReady", 7);
    ...
    this.arcgisHubDiscussionsPostEdit = createEvent(this, "arcgisHubDiscussionsPostEdit", 7);
    this.arcgisHubDiscussionsPostChanged = createEvent(this, "arcgisHubDiscussionsPostChanged", 7);
    ...
    this.arcgisHubDiscussionsPostClose = createEvent(this, "arcgisHubDiscussionsPostClose", 7);
    this.hubTelemetry = createEvent(this, "hubTelemetry", 7);
    this.post = undefined;
    this.postCreator = undefined;
    this.postCreatorOrg = undefined;
  ...
  async handleCreate() {
    ...
    try {
      ...
      this.titleValue = '';
      this.bodyValue = '';
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.create.label.post), { response: dist.constants.response.SUCCESS, details: (_a = post.title) !== null && _a !== void 0 ? _a : null, groupId: channel.groups.join(', '), postId: post.id, channelId: channel.id, channelAccess: channel.access }));
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.create.label.post), { response: dist.constants.response.FAILURE, groupId: channel === null || channel === void 0 ? void 0 : channel.groups.join(', '), channelId, channelAccess: channel === null || channel === void 0 ? void 0 : channel.access }));
  ...
  handleEdit() {
    ...
    return updatePost(Object.assign({ postId: post.id, data: {
      ...
      .then(editedPost => {
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.update.label.post), { response: dist.constants.response.SUCCESS, postId: post.id, channelId, channelAccess: channel.access }));
      editedPost.replyCount = editedPost.replies.total;
      delete editedPost.replies;
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.update.label.post), { response: dist.constants.response.FAILURE, postId: post.id, channelId, channelAccess: channel.access }));
  ...
  handleCreateReply() {
    ...
    return createReply(Object.assign({ postId: parent.id, data: {
      ...
      .then(reply => {
      this.bodyValue = '';
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.create.label.reply), { response: dist.constants.response.SUCCESS, postId: reply.id, parentId: parent.id, channelId: channel.id, channelAccess: channel.access }));
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.create.label.reply), { response: dist.constants.response.FAILURE, parentId: parent.id, channelId: channel.id, channelAccess: channel.access }));
  ...
  handleEditReply() {
    ...
    return updatePost(Object.assign({ postId: post.id, data: {
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.update.label.reply), { response: dist.constants.response.SUCCESS, postId: post.id, parentId, channelId: channel.id, channelAccess: channel.access }));
      arcgisHubDiscussionsPostEdit.emit(updatedReply);
      return updatedReply;
    })
      .catch(e => {
      this.errorMessage = 'editFailure';
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.update.label.reply), { response: dist.constants.response.FAILURE, postId: post.id, parentId, channelId: channel.id, channelAccess: channel.access }));
...
__decorate$3([
  MemoizeDecoratorFactory('bodyValue')
...
__decorate$2([
  CallWhenFactory({ when() { return !this.disabled; } })
...
__decorate$2([
  CallWhenFactory({ when: function ({ geometry }) { return Boolean(geometry); } })
...
const ArcgisHubDiscussionsPostReactions = class {
  ...
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.hubTelemetry = createEvent(this, "hubTelemetry", 7);
    this.arcgisHubDiscussionsPostReactionChange = createEvent(this, "arcgisHubDiscussionsPostReactionChange", 7);
    /**
  ...
  handleAddReactionClick(evt) {
    ...
    this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.interaction.action.open.label.popover.details.addReaction), { postId: post.id, parentId: post.parentId, channelId: channel.id, channelAccess: channel.access }));
  }
  /**
  ...
  handleReactionPopoverOpen(evt) {
    ...
    const payload = reaction === 'overflow'
      ? dist.dictionary.category.interaction.action.open.label.popover.details.reactionOverflow
      : dist.dictionary.category.interaction.action.open.label.popover.details[REACTIONS_MAP[reaction].telemetryKey];
  ...
  async createReaction(reaction) {
    ...
    try {
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.create.label.reaction.details[REACTIONS_MAP[reaction].telemetryKey]), { postId: post.id, parentId: post.id, channelId: channel.id, channelAccess: channel.access, response: dist.constants.response.SUCCESS }));
    }
    catch (e) {
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.create.label.reaction.details[REACTIONS_MAP[reaction].telemetryKey]), { postId: post.id, parentId: post.id, channelId: channel.id, channelAccess: channel.access, response: dist.constants.response.FAILURE }));
  ...
  async deleteUserReaction(userReaction) {
    ...
    try {
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.delete.label.reaction.details[REACTIONS_MAP[userReaction.value].telemetryKey]), { postId: post.id, parentId: post.id, channelId: channel.id, channelAccess: channel.access, response: dist.constants.response.SUCCESS }));
    }
    catch (e) {
      console.error('Failed to delete reaction:', userReaction.value, userReaction.id, e.message);
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.content.action.delete.label.reaction.details[REACTIONS_MAP[userReaction.value].telemetryKey]), { postId: post.id, parentId: post.id, channelId: channel.id, channelAccess: channel.access, response: dist.constants.response.FAILURE }));
      throw e;
    }
  }
  /**
...
const ArcgisLayoutList = class {
  ...
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.arcgisLayoutListLayoutSelected = createEvent(this, "arcgisLayoutListLayoutSelected", 7);
    this.layout = 'list';
    this.disabled = false;
...
export { ArcgisHubDiscussionsBlockedNotice as arcgis_hub_discussions_blocked_notice, ArcgisHubDiscussionsPopover as arcgis_hub_discussions_popover, ArcgisHubDiscussionsPost as arcgis_hub_discussions_post, ArcgisHubDiscussionsPostChips as arcgis_hub_discussions_post_chips, ArcgisHubDiscussionsPostEditor as arcgis_hub_discussions_post_editor, ArcgisHubDiscussionsPostGeography as arcgis_hub_discussions_post_geography, ArcgisHubDiscussionsPostHeader as arcgis_hub_discussions_post_header, ArcgisHubDiscussionsPostReactions as arcgis_hub_discussions_post_reactions, ArcgisHubDiscussionsPostSkeleton as arcgis_hub_discussions_post_skeleton, ArcgisLayoutList as arcgis_layout_list, ArcgisLoadMoreButton as arcgis_load_more_button };
