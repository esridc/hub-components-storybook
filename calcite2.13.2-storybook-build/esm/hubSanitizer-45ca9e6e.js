import { S as Sanitizer, l as lib } from './index-55cb25f7.js';
...
function hubSafeAttrValue(tag, name, value, cssFilter) {
  ...
  if ((tag === "a" || isCalciteComponent) && name === 'href') {
    ...
    return lib.safeAttrValue(tag, name, value, cssFilter);
  }
}
/**
 * Hub Sanitizer Rules
...
export { ALLOWED_PROTOCOLS as A, SVG_TAGS as S, sanitizeMarkdown as a, sanitizePreviewMarkdown as b, sanitizeHtml as c, sanitizeHeadContent as d, sanitizeUrl as e, hubSafeAttrValue as h, onlyLinks as o, stripHtml as s, validateHtml as v };
