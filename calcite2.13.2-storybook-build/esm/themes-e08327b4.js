import { _ as _getAuthHeader, a as _getDomainServiceUrl, d as domainExists, s as stripProtocol } from './domain-exists-4fd7dc09.js';
import { s as searchItems } from './search-c7a57aa9.js';
import { a as includes, g as getHubApiUrl } from './compose-d5b83ab7.js';
import { a as cloneObject, e as extend } from './util-3e6872d9.js';
import { g as generateRandomString } from './generate-random-string-1436d9e6.js';
import { g as getProp } from './get-prop-ec5be510.js';
import { a as bboxToString } from './extent-34a4ba2a.js';
import { d as determineOwner, a as getItem, b as getItemResources, c as getItemData, e as getItemResource } from './get-f0caeb52.js';
import { u as updateItemResource, a as updateItem } from './update-6a7d5697.js';
import { c as createItem } from './create-de41f6f6.js';
import { t as truncateSlug, T as TYPEKEYWORD_SLUG_PREFIX, u as uriSlugToKeywordSlug } from './slugs-7ec67036.js';
...
const migrateLegacyCapabilitiesToFeatures = (model) => {
    ...
    (getProp(model, "data.values.capabilities") || []).forEach((capability) => {
...
function _migrateTelemetryConfig(model) {
    ...
    clone.data.telemetry.consentNotice = {
        ...
        disclaimer: [
            {
                text: getProp(model, "data.values.telemetry.consentNotice.consentText") ||
                    "",
                default: true,
            },
        ],
        policyURL: getProp(model, "data.values.telemetry.consentNotice.policyURL") || "",
    };
...
function migrateBadBasemap(model) {
    ...
    if (getProp(model, "data.values.map.basemaps"))
        return model;
...
function migrateWebMappingApplicationSites(model) {
    const isWebMappingApplication = getProp(model, "item.type") === "Web Mapping Application";
    const hasHubSiteKeyword = getWithDefault(model, "item.typeKeywords", []).includes("hubSite");
...
export { _migrateTelemetryConfig as A, upgradeSiteSchema as B, domainExistsPortal as C, DEFAULT_THEME as D, getUniqueDomainNamePortal as E, getUniqueDomainName as F, _checkStatusAndParseJson as G, getModelBySlug as H, upsertModelResources as I, fetchModelResources as J, stringToBlob as K, _migrateLinkUnderlinesCapability as L, _lookupPortal as M, _ensureSafeDomainLength as N, SITE_SCHEMA_VERSION as S, _ensureTelemetry as _, getItemBySlug as a, getUniqueSlug as b, findItemsBySlug as c, constructSlug as d, createModel as e, fetchModelFromItem as f, getSiteById as g, getModel as h, addDomain as i, capabilityToFeatureMap as j, ensureUniqueDomainName as k, lookupDomain as l, getOrgDefaultTheme as m, addSiteDomains as n, removeDomainsBySiteId as o, addItemResource as p, upsertResource as q, removeDomain as r, setSlugKeyword as s, doesResourceExist as t, updateModel as u, removeEmptyProps as v, migrateBadBasemap as w, migrateWebMappingApplicationSites as x, _migrateFeedConfig as y, _migrateEventListCardConfigs as z };
