...
__decorate([
  MemoizeDecoratorFactory('cardConfig')
], ArcgisHubEventGalleryCard.prototype, "_cardConfig", null);
__decorate([
  MemoizeDecoratorFactory('_cardConfig.entityIds', '_cardConfig.access', '_cardConfig.tags', '_cardConfig.categories')
], ArcgisHubEventGalleryCard.prototype, "dynamicModePredicate", null);
__decorate([
  MemoizeDecoratorFactory('_cardConfig.eventIds')
], ArcgisHubEventGalleryCard.prototype, "manualModePredicate", null);
__decorate([
  MemoizeDecoratorFactory('_cardConfig.selectionMode', 'dynamicModePredicate', 'manualModePredicate')
...
export { ArcgisHubEventGalleryCard as arcgis_hub_event_gallery_card };
