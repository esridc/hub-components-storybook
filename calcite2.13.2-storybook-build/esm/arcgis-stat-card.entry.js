...
import { a as SOURCE, L as LAYOUTS, A as ALIGNMENTS, U as UNIT_POSITIONS, b as ICONS, V as VISUAL_INTEREST, C as CORNERS, D as DROP_SHADOWS, S as SCALE } from './interfaces-0d0bef14.js';
...
const ArcgisStatCard = class {
  ...
  handleLinkNavigation() {
    this.hubTelemetry.emit(Object.assign({}, dist.dictionary.category.navigation.action.view.label.content));
  }
  /**
  ...
  handleModalClose() {
    this.isModalOpen = false;
    this.hubTelemetry.emit(Object.assign({}, dist.dictionary.category.interaction.action.close.label.modal.details.info));
  }
  /**
  ...
  handleModalOpen() {
    ...
    this.hubTelemetry.emit(Object.assign({}, dist.dictionary.category.interaction.action.open.label.modal.details.info));
  }
  /**
