 ...
 * @returns {string}
 */
const getPropertyPathFromScope = (scope) => {
  const result = scope && jsonPointer.parse(scope)
 ...
 * @returns
 */
const getPropertyPathFromId = (id) => {
 ...
 * @returns
 */
const getWhiteListPropertyFromId = (id) => {
  const propertyPath = getPropertyPathFromId(id);
  return propertyPath === null || propertyPath === void 0 ? void 0 : propertyPath.split(".")[0];
};

export { getPropertyPathFromId as a, getWhiteListPropertyFromId as b, getPropertyPathFromScope as g, jsonPointer as j };
