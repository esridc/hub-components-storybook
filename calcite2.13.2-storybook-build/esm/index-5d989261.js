...
function point (state = SYMBOL_STATE.DEFAULT, properties = defaultLayerThemeOptions.point) {
...
function polyline (state = SYMBOL_STATE.DEFAULT, properties = defaultLayerThemeOptions.polyline) {
...
function polygon (state = SYMBOL_STATE.DEFAULT, properties = defaultLayerThemeOptions.polygon) {
  const { activeColor, color, hoverColor, width } = properties;
  let strokeColor = color;
  if (state === SYMBOL_STATE.HOVER) {
    strokeColor = hoverColor;
...
export { SYMBOL_STATE as S, defaultLayerThemeOptions as d, getMaxDeviation as g, symbols as s };
