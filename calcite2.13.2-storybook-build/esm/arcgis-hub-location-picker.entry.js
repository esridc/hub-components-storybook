...
import { d as defaultLayerThemeOptions, g as getMaxDeviation, s as symbols, S as SYMBOL_STATE } from './index-5d989261.js';
import { project } from '@arcgis/core/geometry/support/webMercatorUtils.js';
import { g as getFirstHitGraphic } from './arcgis-1e3a04cd.js';
import Graphic from '@arcgis/core/Graphic.js';
import { i as intlManager } from './intl-manager-13176c32.js';
import Polygon from '@arcgis/core/geometry/Polygon.js';
import SpatialReference from '@arcgis/core/geometry/SpatialReference.js';
import Extent from '@arcgis/core/geometry/Extent.js';
import { g as getExtentSymbol, a as getPointCount, b as getGeometryTypeDrawTool } from './map-d797b63c.js';
...
import { b as bBoxToExtent, c as extentToBBox } from './extent-34a4ba2a.js';
...
const ArcgisHubLocationPicker = class {
  constructor(hostRef) {
    ...
    this.arcgisHubLocationPickerUpdate = createEvent(this, "arcgisHubLocationPickerUpdate", 7);
  ...
  */
  ...
  async handleListItemSelect(e) {
    ...
    if (selected.location.type !== this._selectedType) {
      ...
      this.hubTelemetry.emit(Object.assign(Object.assign({}, dist.dictionary.category.interaction.action.select), { label: selected.label }));
    }
  }
  /**
  ...
  async clearEditState() {
    ...
    this._emitLocationWithFallback();
    // telemetry
    this.hubTelemetry.emit(dist.dictionary.category.interaction.action.remove.label.location.details.clearAll);
  }
