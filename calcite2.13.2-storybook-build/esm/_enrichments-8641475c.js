...
import { f as getItemOrgId } from './compose-d5b83ab7.js';
import { a as getItem, g as getItemGroups, c as getItemData, f as getItemMetadata } from './get-f0caeb52.js';
import { p as parseServiceUrl } from './helpers-8c7e5e31.js';
import { O as OperationError } from './OperationError-387ae9ab.js';
...
async function parseMetadataXml(metadataXml) {
    ...
    const { parse } = await import('./parser-49aa0360.js').then(function (n) { return n.p; });
...
export { OperationStack as O, __assign as _, createOperationPipeline as c, fetchItemEnrichments as f, getEnrichmentErrors as g, isServicesDirectoryDisabled as i };
