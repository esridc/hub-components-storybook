import { capitalize, dasherize, getProp } from "@esri/hub-common";
import { TYPEMAP } from "@esri/hub-teams";
/**
 ...
 */
export const getElementPath = (composedPath) => {
  let length = 0;
 ...
 */
export const transformDimensions = (dimensions = {}, site) => {
 ...
 * @returns {String}
 */
export const getResponse = (isSuccess) => {
  let response;
  if (isSuccess === false) {
    response = 'Failure';
  }
...
export const getEntityTelemetryDimensions = (entity) => {
