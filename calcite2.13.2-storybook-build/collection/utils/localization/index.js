import { RTLLocales, SupportedLocales, SupportedLocalesForFormats } from "./interfaces";
 ...
 * @param element
 */
export function getLocaleInfo(element = document.documentElement) {
  var _a;
 ...
 * @param baseURL
 */
export async function fetchComponentLocaleStrings(element, baseURL, fileNamePattern) {
 ...
 * @param element
 */
export function fetchLanguageDirection(element) {
 ...
 */
export function localeParseFloat(localizedString, locale) {
