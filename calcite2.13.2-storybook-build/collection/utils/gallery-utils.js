import { bboxToString, titleize, cloneObject } from '@esri/hub-common';
/**
 ...
 * @returns
 */
export function addPathToResults(path, results) {
  if (path) {
 ...
 */
export function getListFacets(facets = []) {
 ...
 * @param facet
 */
export function isListFacet(facet) {
 ...
 */
export function getDateRangeFacets(facets = []) {
 ...
 * @param facet
 */
export function isDateRangeFacet(facet) {
 ...
 * @returns all date-range facets within the array
 */
export function getTreeFacets(facets = []) {
 ...
 * @param facet
 */
export function isTreeFacet(facet) {
 ...
 */
export function getOptionsBasedFacets(facets = []) {
 ...
 * @param facet
 */
export function isOptionsBasedFacet(facet) {
 ...
 */
export function getMapFacets(facets = []) {
 ...
 */
export function filterFacetsBasedOnLayout(facets, layout) {
 ...
 * @param facet
 */
export function isMapFacet(facet) {
 ...
 */
export function hasMapFacets(facets) {
 ...
 */
export function willStateChange(currentState, userInput) {
 ...
 * @returns
 */
export function applyGalleryState(state, serializedState) {
 ...
 */
export function resetFacet(facet) {
 ...
 * @returns a resetted copy of the facet
 */
export function resetOptionsBasedFacet(facet) {
 ...
 * @returns a resetted copy of the facet
 */
export function resetDateRangeFacet(facet) {
  const resetted = cloneObject(facet);
 ...
 * @returns a resetted copy of the facet
 */
export function resetMapFacet(facet) {
  const resetted = cloneObject(facet);
  resetted.value = null;
  return resetted;
}
 ...
 * @returns
 */
export function serializeGalleryState(state) {
  var _a;
 ...
 */
export function convertToQueryString(serializedState) {
 ...
 * @returns
 */
export function applyListFacetState(facet, state) {
 ...
 * @returns
 */
export function applyTreeFacetState(facet, state) {
  const updated = cloneObject(facet);
  const stateEntry = state[facet.key];
 ...
 * @returns
 */
export function serializeOptionsBasedFacetState(facet) {
  const state = {};
 ...
 */
export function removeCountLabel(label) {
  return label
    .replace(/\(\d+\)/, '')
 ...
 */
export function addCountToLabel(label, count, intl) {
  return count == null
    ? label
    : intl.direction === 'rtl'
 ...
 */
export function processCommonDynamicOptions(facet, intl) {
 ...
 */
export function processCategoriesFacetOptions(existingOptions) {
 ...
 */
export function navigate(url, target = '_self') {
  if (url) {
