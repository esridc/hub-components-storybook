export const SUBTITLE = `The following harness demonstrates how to include basic sectioning in your editor:
  ...
  elements: [
    {
      ...
      options: {
        ...
        requiredHelperText: {
          label: 'This is required helper text for the details section. It overwrites the default "*indicates required field" that would normally display.'
        }
      },
      elements: [
        {
