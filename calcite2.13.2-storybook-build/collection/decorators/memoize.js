import { generateRandomString, getProp } from "@esri/hub-common";
/**
 ...
 */
export default function MemoizeDecoratorFactory(...pathsToWatch) {
  function MemoizeDecorator(_target, _propertyKey, descriptor) {
    const { get: getter } = descriptor;
    const cacheId = generateRandomString(32);
    const get = function MemoizeDecorator() {
      ...
      const compute = () => {
        ...
        const previousPathValues = pathsToWatch.reduce((acc, pathToWatch) => (Object.assign(Object.assign({}, acc), { [pathToWatch]: getProp(this, pathToWatch) })), {});
        this._memoizeCache[cacheId] = { previousPathValues, value };
        return value;
      };
      // values previously computed
      if (this._memoizeCache[cacheId]) {
        const shouldRecompute = pathsToWatch.some(pathToWatch => this._memoizeCache[cacheId].previousPathValues[pathToWatch] !== getProp(this, pathToWatch));
