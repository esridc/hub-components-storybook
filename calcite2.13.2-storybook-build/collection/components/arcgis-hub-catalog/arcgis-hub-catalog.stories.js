...
export default {
  ...
  parameters: {
    actions: {
      handles: ['arcgisHubCatalogActiveCatalogChange', 'arcgisHubCatalogActiveCollectionChange', 'hubTelemetry'],
    },
  },
  decorators: [
    withRenderCallback('arcgis-hub-catalog', ($el, { args }) => {
      $el.catalogs = args.catalogs;
      $el.facets = args.facets;
      $el.cardActionLinks = args.cardActionLinks;
    })
  ],
  argTypes: {
    catalogs: {
