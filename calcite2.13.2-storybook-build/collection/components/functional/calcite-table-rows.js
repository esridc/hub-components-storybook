...
export const CalciteTableRows = ({ rows, columns, emptyHelpState, startItem = 1, setFirstCellRefCallback }) => {
  ...
  const bodyRows = rows.length
    ...
    : h("calcite-table-row", null, h("calcite-table-cell", { colSpan: columns.length, ref: !!setFirstCellRefCallback && setFirstCellRefCallback }, h("arcgis-hub-help-state", { icon: emptyHelpState.icon }, h("h3", { "aria-live": "polite", role: "status", slot: "message" }, emptyHelpState.heading))));
