import { bBoxToExtent, getProp } from "@esri/hub-common";
/**
 ...
 */
export const WELL_KNOWN_FACET_TYPES = [
  "location",
  "type",
  "source",
  "tags",
 ...
 */
export function hydrateFacets(facets, context, intl, options) {
 ...
 * @returns
 */
export function filterFacetsbyTargetEntity(facets, targetEntity) {
...
function createLocationFacet(_context, intl, options) {
  return {
    ...
    field: 'bbox',
    value: null,
    extent: (options === null || options === void 0 ? void 0 : options.facetExtent) || bBoxToExtent([[-180, -90], [180, 90]]),
...
function createGroupRoleFacet(_context, intl) {
  var _a;
  const managerGroupIds = (_a = getProp(_context, 'currentUser.groups')) === null || _a === void 0 ? void 0 : _a.reduce((accum, g) => {
    ...
    options: [
      ...
      },
      {
        ...
        predicates: [{
            searchUserAccess: 'groupMember',
            owner: {
              not: getProp(_context, 'session.username')
            }
          }]
      },
      {
      ...
      },
      {
        ...
        selected: false,
        predicates: [{
            owner: getProp(_context, 'session.username')
          }]
      }
    ],
    validTargetEntities: ["group"],
    ...
    options: [
      {
        ...
        predicates: [
          {
            owner: getProp(_context, 'currentUser.id'),
          },
        ],
      },
      {
        ...
        predicates: [
          {
            orgId: getProp(_context, 'currentUser.orgId'),
          },
        ],
      },
      {
