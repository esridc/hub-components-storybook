...
import { capitalize, checkPermission, getItemHomeUrl, getRelativeWorkspaceUrl, getTypeFromEntity } from '@esri/hub-common';
import { getGlobalContext } from '../../utils/state';
import { getAccessIcon } from '../../utils/get-access-icon';
import { dictionary } from '@esri/telemetry-dictionary-hub';
export class ArcgisHubLayoutEditorHeader {
  constructor() {
    this.handleWorkspaceItemClick = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.navigation.action.view.label.content.details.workspace });
    };
    this.handleSiteMenuItemClick = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.interaction.action.open.label.popover.details.site });
    };
    this.handleAccessChange = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.interaction.action.open.label.sidePanel.details.sharing });
      this.arcgisHubLayoutEditorHeaderShare.emit(this.entity);
    };
    this.handleEditS123ButtonClick = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.navigation.action.edit.label.content });
    };
    this.handleViewButtonClick = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.interaction.action.open.label.menu.details.view });
    };
    this.handlePreviewPublished = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.navigation.action.view.label.content.details.publishedDraft });
      this.arcgisHubLayoutEditorHeaderPreviewPublished.emit(this.entity);
    };
    this.handlePreviewDraft = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.navigation.action.view.label.content.details.previewDraft });
      this.arcgisHubLayoutEditorHeaderPreviewDraft.emit(this.entity);
    };
    this.handlePublish = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.content.action.update.label.layout.details.publish });
    ...
    this.handleOverflowButtonClick = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.interaction.action.open.label.menu.details.options });
    };
    this.handleClone = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.content.action.create.label.site.details.clone });
    ...
    this.handleDelete = () => {
      ...
      const telemetry = dictionary.category.content.action.delete.label[type];
      this.hubTelemetry.emit({ telemetry });
      this.arcgisHubLayoutEditorHeaderDelete.emit(this.entity);
    };
    this.handleSaveAsTemplate = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.content.action.create.label.template.details.site });
      this.arcgisHubLayoutEditorHeaderSaveAsTemplate.emit(this.entity);
    };
    this.handleEditLayout = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.navigation.action.view.label.content.details.layoutEditor });
    };
    this.handleViewSite = () => {
      this.hubTelemetry.emit({ telemetry: dictionary.category.navigation.action.view.label.content.details.site });
    };
  ...
  static get is() { return "arcgis-hub-layout-editor-header"; }
  static get encapsulation() { return "shadow"; }
  static get originalStyleUrls() {
    return {
      "$": ["arcgis-hub-layout-editor-header.css"]
    };
  }
  ...
  static get properties() {
    return {
      ...
      "saveButtonDisabled": {
        ...
        "attribute": "save-button-disabled",
        "reflect": false
      },
      "isDirty": {
        "type": "boolean",
  ...
  static get events() {
    return [{
        "method": "arcgisHubLayoutEditorHeaderShare",
        "name": "arcgisHubLayoutEditorHeaderShare",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "arcgisHubLayoutEditorHeaderPreviewPublished",
        "name": "arcgisHubLayoutEditorHeaderPreviewPublished",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "arcgisHubLayoutEditorHeaderPreviewDraft",
        "name": "arcgisHubLayoutEditorHeaderPreviewDraft",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "arcgisHubLayoutEditorHeaderPublish",
        "name": "arcgisHubLayoutEditorHeaderPublish",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "arcgisHubLayoutEditorHeaderSave",
        "name": "arcgisHubLayoutEditorHeaderSave",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "arcgisHubLayoutEditorHeaderClone",
        "name": "arcgisHubLayoutEditorHeaderClone",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "arcgisHubLayoutEditorHeaderDeleteDraft",
        "name": "arcgisHubLayoutEditorHeaderDeleteDraft",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "arcgisHubLayoutEditorHeaderDelete",
        "name": "arcgisHubLayoutEditorHeaderDelete",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
        ...
        "method": "arcgisHubLayoutEditorHeaderSaveAsTemplate",
        "name": "arcgisHubLayoutEditorHeaderSaveAsTemplate",
        "bubbles": true,
        "cancelable": true,
        "composed": true,
        "docs": {
